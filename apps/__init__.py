...
from apps.view.token import token_prefix, token_router, token_router
from apps.view.pusher import pusher_prefix, pusher_router, pusher_router
from apps.view.record import record_prefix, record_router, record_router
...
ROUTERS = [
    ...
    (token_router, [token_prefix], token_prefix),
    (pusher_router, [pusher_prefix], pusher_prefix),
    (record_router, [record_prefix], record_prefix),
]
